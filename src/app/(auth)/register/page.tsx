    ...
    <div className="relative grid min-h-screen grid-cols-1 lg:grid-cols-[1.3fr_minmax(420px,520px)]">
      <aside className="relative hidden overflow-hidden lg:block">
        <div className="flex h-full flex-col justify-between p-12">
          ...
          <div>
            <p className="mb-4 text-xs uppercase tracking-[0.32em] text-rose-500">Mulai cerita</p>
            ...
            <p className="mt-8 max-w-md text-base text-stone-600">
              Draf gratis, kapan pun selesai. Bayar paket hanya saat siap menyebar ke tamu, bukan
              saat masih merancang.
            </p>
          </div>
