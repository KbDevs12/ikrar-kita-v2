...
const IslamicElegant = dynamic(() => import("./islamic-elegant").then((m) => m.IslamicElegant))
...
const CinematicStory = dynamic(() => import("./cinematic-story").then((m) => m.CinematicStory))

// ─── 20 additional bespoke templates ─────────────────────────────────────────
const JavaneseRoyal = dynamic(() => import("./javanese-royal").then((m) => m.JavaneseRoyal))
const SundaneseNature = dynamic(() => import("./sundanese-nature").then((m) => m.SundaneseNature))
const BalineseTemple = dynamic(() => import("./balinese-temple").then((m) => m.BalineseTemple))
...
const WaterfrontBlue = dynamic(() => import("./waterfront-blue").then((m) => m.WaterfrontBlue))
...
const CelestialNight = dynamic(() => import("./celestial-night").then((m) => m.CelestialNight))
...
export function getTemplateComponent(id: string): ComponentType<InvitationTemplateProps> {
